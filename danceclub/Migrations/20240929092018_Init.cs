    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupDanceTypes", x => new { x.DanceTypeId, x.GroupId });
                    table.ForeignKey(
                        name: "FK_GroupDanceTypes_DanceTypes_DanceTypeId",
                        column: x => x.DanceTypeId,
                        principalTable: "DanceTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupDanceTypes_Groups_GroupId",
                        column: x => x.GroupId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Schedules_DanceTypes_DanceTypeId",
                        column: x => x.DanceTypeId,
                        principalTable: "DanceTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupDanceTypes_GroupId",
                table: "GroupDanceTypes",
                column: "GroupId");
